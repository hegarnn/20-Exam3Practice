...
def run_test_zero_changer():
    ...
    test2 = ([8, 4, 0, 0], [77, 0, 6, 1, 5, 0], [4, 4, 4], [4, 0, 4])
    expected2 = ([8, 4, 1, 2], [77, 3, 6, 1, 5, 4], [4, 4, 4], [4, 5, 4])
    zero_changer(test2)
    print()
    print('Test 1:')
    ...
    test1 = ([0, 0, 0, 0], [5, 2, 3, 1, 5, 6], [4, 4, 4], [4, 0, 4])
    expected1 = ([1, 2, 3, 4], [5, 2, 3, 1, 5, 6], [4, 4, 4], [4, 5, 4])
    zero_changer(test1)
    print()
    print('Test 1:')
    print('  Expected:', expected1)
